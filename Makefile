...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Thu Jun 19 10:44:28 2014
...
CC            = /usr/bin/gcc-4.2
CXX           = /usr/bin/g++-4.2
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DMAC_OSX -DMSG_NOSIGNAL=0 -DHAVE_BUILD_INFO -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -pipe -O2 -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.6 -pthread -Wall -W $(DEFINES)
CXXFLAGS      = -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2 -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.6 -pthread -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
INCPATH       = -I/opt/local/share/qt4/mkspecs/macx-g++ -Ibuild -I/opt/local/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtGui.framework/Versions/4/Headers -Isrc -Isrc/json -Isrc/qt -Isrc/leveldb/include -Isrc/leveldb/helpers -I/opt/local/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/opt/local/include -Ibuild -F/opt/local/Library/Frameworks -F/opt/local/lib
LINK          = /usr/bin/g++-4.2
LFLAGS        = -headerpad_max_install_names -fstack-protector-all --param ssp-buffer-size=1 -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.6
LIBS          = $(SUBLIBS) -F/opt/local/Library/Frameworks -F/opt/local/lib  -lminiupnpc -framework Foundation -framework ApplicationServices -framework AppKit -framework CoreServices /opt/local/lib/libdb_cxx.a /opt/local/lib/libboost_system-mt.a /opt/local/lib/libboost_filesystem-mt.a /opt/local/lib/libboost_chrono-mt.a /opt/local/lib/libboost_program_options-mt.a /opt/local/lib/libboost_thread-mt.a /Users/User/kashmircoin/src/leveldb/libleveldb.a /Users/User/kashmircoin/src/leveldb/libmemenv.a -L/opt/local/lib -lssl -lcrypto -ldb_cxx-4.8 -lboost_system-mt -lboost_filesystem-mt -lboost_program_options-mt -lboost_thread-mt -lboost_chrono-mt -F/opt/local/Library/Frameworks -F/opt/local/lib -framework QtGui -framework QtCore 
AR            = ar cq
RANLIB        = ranlib -s
...
SOURCES       = src/txdb-leveldb.cpp \
		...
		src/zerocoin/ZeroTest.cpp build/moc_macdockiconhandler.cpp \
...
all: Makefile kashmircoin-qt.app/Contents/PkgInfo kashmircoin-qt.app/Contents/Resources/empty.lproj kashmircoin-qt.app/Contents/Info.plist kashmircoin-qt.app/Contents/Resources/PandaCoin.icns $(TARGET)

$(TARGET): /Users/User/kashmircoin/src/leveldb/libleveldb.a /Users/User/kashmircoin/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
...
/Users/User/kashmircoin/src/leveldb/libleveldb.a: FORCE
	cd /Users/User/kashmircoin/src/leveldb && CC=/usr/bin/gcc-4.2 CXX=/usr/bin/g++-4.2 $(MAKE) OPT="-pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/Users/User/kashmircoin/build/build.h: FORCE
	cd /Users/User/kashmircoin; /bin/sh share/genbuild.sh /Users/User/kashmircoin/build/build.h
